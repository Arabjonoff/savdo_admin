...
class UpdateIncomePayScreen extends StatefulWidget {
  final Tolov1 data;
  final int? idSklRs;
  final bool isIdSklRs;
  const UpdateIncomePayScreen({super.key, required this.data, this.idSklRs,this.isIdSklRs =false});

  @override
  State<UpdateIncomePayScreen> createState() => _UpdateIncomePayScreenState();
}

class _UpdateIncomePayScreenState extends State<UpdateIncomePayScreen> {
