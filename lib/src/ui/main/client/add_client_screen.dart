...
class _AddClientScreenState extends State<AddClientScreen> {
  ...
  final TextEditingController _controllerActivity = TextEditingController();
  final TextEditingController _controllerActivityName = TextEditingController();
  final TextEditingController _controllerTerritory = TextEditingController();
  final TextEditingController _controllerTerritoryName = TextEditingController();
