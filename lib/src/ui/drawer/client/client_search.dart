...
class ClientSearchScreen extends StatefulWidget {
  ...
  const ClientSearchScreen({super.key, required this.clientType});
...
class _ClientSearchScreenState extends State<ClientSearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.clientType ==0?"Харидорлар":"Мол етказувчи"),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: CupertinoSearchTextField(
              ...
              placeholder: "Излаш",
              onChanged: (i)async{
                await clientBloc.getAllClientSearch(i);
              },
            ),
          ),
