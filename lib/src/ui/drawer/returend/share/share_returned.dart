...
class ShareReturnedScreen extends StatefulWidget {
  final ReturnedResult data;
  const ShareReturnedScreen({super.key, required this.data});

  @override
  State<ShareReturnedScreen> createState() => _ShareReturnedScreenState();
}

class _ShareReturnedScreenState extends State<ShareReturnedScreen> {
                ...
                child: RepaintBoundary(
                  child: Column(
                    ...
                    children: [
                      ...
                      /// Header
                      createTable(widget.data.sklVzTov),
                      Table(
  ...
  Widget createTable(List<SklVzTov> data,) {
    List<TableRow> rows = [
      TableRow(
          decoration: BoxDecoration(
              border: Border.all(color: Colors.grey,width: 0.5)
