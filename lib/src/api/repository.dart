...
class Repository{
  ...
  Future<List<ClientResult>> getClientSearch(obj) => _dbClient.getClientSearch(obj);
  ...
  Future<HttpResult> getWarehouseTransfer(year,month,idSkl) => _apiProvider.getWarehouseTransfer(year,month,idSkl);
