...
PaymentsModel getPaymentsModelFromJson(String str) => PaymentsModel.fromJson(json.decode(str));

String getPaymentsModelToJson(PaymentsModel data) => json.encode(data.toJson());
...
class PaymentsModel {
  ...
  factory PaymentsModel.fromJson(Map<String, dynamic> json) => PaymentsModel(
    data: List<PaymentsResult>.from(json["data"].map((x) => PaymentsResult.fromJson(x))),
  );
...
class PaymentsResult {
  ...
  factory PaymentsResult.fromJson(Map<String, dynamic> json) => PaymentsResult(
    id: json["ID"]??0,
    ...
    tl1: json["TL1"] == null?<Tolov1>[]:List<Tolov1>.from(json["TL1"].map((x) => Tolov1.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "T_HAR": List<dynamic>.from(tHar.map((x) => x)),
...
class Tolov1 {
  ...
  factory Tolov1.fromJson(Map<String, dynamic> json) => Tolov1(
    id: json["ID"]??0,
    sana: json["SANA"] == null?DateTime.now():DateTime.parse(json["SANA"]),
    idToch: json["ID_TOCH"]??"",
    name: json["NAME"]??"",
